...
var releaseTag = core.getInput('release-tag', requiredArgOptions);
var failForPrerelease = core.getBooleanInput('fail-for-prerelease');
var octokit = github.getOctokit(token);
var loggingFunction = failForPrerelease ? core.setFailed : core.info;
async function run() {
